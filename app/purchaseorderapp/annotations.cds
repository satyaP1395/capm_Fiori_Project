...
// purchase items annotations :
annotate service.POs with @(
    //   annotation used for selection fields or search fileds.
    UI.SelectionFields      : [
        PO_ID,
    ...
    //  header info annotatins to count number of items on object
    UI.HeaderInfo           : {
    ...
    // annotatins used for to generate table columns :
    UI.LineItem             : [
        {
            $Type: 'UI.DataField',
            Value: PO_ID,
